...
namespace QuestionForm
{
    public partial class RezaltFormTraining : Form
    {
        ...
        InitializeComponent();
            ...
            if (ExamForm.count > 0 || TrainingForm.count > 0)
            {
            ...
            else
            {
                ...
                lblEndDateTime.Text = " ";
                var sessionTrainig = new List<Session>
                {
                    new Session{UserId=user.Id,Marks=mark*100}

                };
                context.Sessions.AddRange(sessionTrainig);
                context.SaveChanges();
            }
